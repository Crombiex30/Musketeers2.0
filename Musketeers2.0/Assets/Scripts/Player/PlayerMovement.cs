...
public class PlayerMovement:MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        float horizontalInput = Input.GetAxis("Horizontal");    //This code helps with side to side movement
        float verticalInput = Input.GetAxis("Vertical");        //This code helps with forward and backwards movement
